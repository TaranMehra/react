...
function Header() {
  return (
    <div className='header-container bg-orange-50 p-2 flex justify-between'>
        {/* <h1>Web App : </h1> */}
        <NavLink to="/app/dashboard" className="bg-orange-200 hover:bg-orange-400 text-white font-bold py-2 px-4 rounded z-10">
            Home
        </NavLink>
        <NavLink to="/app/profile" className="bg-green-800 hover:bg-green-400 text-white font-bold py-2 px-4 rounded">
            Profile
        </NavLink>
